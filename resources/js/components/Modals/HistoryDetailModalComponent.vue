            ...
            <div class="modal-window border border-4 border-dark">
                <div class="modal-content">
                    <div class="card modal-cs">
                        ...
                        <div class="card-body col-12 modal-cd-detail fs-24">
                            ...
                            <div class="col-12 d-flex my-1" v-if="order.discount !== 0">
                                <div class="col-4 fw-bold">割引金額</div>
                                <div class="col-8">{{ order.reduction.toLocaleString() }}円</div>
                            </div>
                            <div class="col-12 d-flex my-1">
